...
class MOHYSEPreprocessor:
    ...
    def create_rvh_file(self, template: bool = False):
        ...
        if subbasins_config:
            ...
            for sb in subbasins_config:
                sp_rows.append(
                    f"  {sb['id']:10d},  {self.params['MOHYSE'][param_or_name]['X09']},"
                    f"          {self.params['MOHYSE'][param_or_name]['Mohyse_Gamma_Scale']},"
                )
    ...
    def _create_forcing_block(self, param_or_name: str) -> Dict[str, List[str]]:
        ...
        snow_corr = self.params['MOHYSE'][param_or_name].get('X12', 1.0)
    ...
    def _create_rvi_sections(self, start_date: str, end_date: str, cali_end_date: str,
        ...
        return {
            ...
            "#Model Options": [
                ...
                f":Evaporation                {'PET_OUDIN' if self._pet_method and self._pet_method.upper() == 'OUDIN' else 'PET_MOHYSE'}",
