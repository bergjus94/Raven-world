...
PIPELINE_CASES = [
    ...
    pytest.param("9999", "HMETS", "ERA5", False, False, id="hmets_era5_single"),
    pytest.param("9900", "HMETS", "ERA5", False, True,  id="hmets_era5_multi"),
    pytest.param("9999", "MOHYSE","ERA5", False, False, id="mohyse_era5_single"),
    pytest.param("9900", "MOHYSE","ERA5", False, True,  id="mohyse_era5_multi"),
